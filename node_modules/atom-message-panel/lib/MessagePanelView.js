...
MessagePanelView.prototype.setSummary = function (summary) {
  ...
  message = message.substr(0, message.indexOf('<br />'));
  message += "..."
...
MessagePanelView.prototype.show = function () {
  //this.btnFold.addClass('icon-fold');
  //this.body.css('display', 'inline-block');
  //this.summary.css('display', 'inline-block');
  //this.panel.css('display', 'inline-block');
  this.panel.show(this.speed);
};

MessagePanelView.prototype.hide = function () {
  //this.btnFold.addClass('icon-unfold');
  this.panel.hide(this.speed);
  //this.summary.hide();
};
